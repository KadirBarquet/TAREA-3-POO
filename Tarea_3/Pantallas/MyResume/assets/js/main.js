(function () {
  ...
  // Function to generate calendar HTML for a given month
  ...
  const updateCalendar = (year, month) => {
    const calendarTable = select('.calendar table tbody');
    calendarTable.innerHTML = generateCalendarHTML(year, month);
  };
